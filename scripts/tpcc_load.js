 ...
 * sql> CREATE DATABASE tpcc TEMPLATE template0 ENCODING 'UTF-8' LC_COLLATE 'C' LC_CTYPE 'C';
 * sql> CREATE USER tpcc PASSWORD 'tpcc';
 * shell> psql -U postgres tpcc
 * sql> CREATE SCHEMA AUTHORIZATION tpcc;
 *
 * <postgresql.conf>
 * listen_addresses = '*'
 * port = 5432
